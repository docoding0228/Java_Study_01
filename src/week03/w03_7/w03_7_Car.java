...
public class w03_7_Car {
    ...
    public w03_7_Car(String model, String color, double price) {
        this.model = model;
        this.color = color;
        this.price = price;
    }

    public void setTire(w03_7_Tire ... tire) {
        this.tire = tire;
    }

    public void setDoor(w03_7_Door ... door) {
        this.door = door;
    }

    public void setHandle(w03_7_Handle handle) {
        this.handle = handle;
    }
